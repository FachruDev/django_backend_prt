...
# For Article
class ArticleTag(TranslatableModel):
    translations = TranslatedFields(
        title=models.CharField(_("Title"), max_length=100),
    )
    class Meta: verbose_name = _("Article Tag"); verbose_name_plural = _("Article Tags")
...
class ArticleCategory(TranslatableModel):
    ...
    class Meta: verbose_name = _("Article Category"); verbose_name_plural = _("Article Categories")
    def __str__(self): return self.title

class Article(TranslatableModel, SEOModel):
    ...
    class Meta: verbose_name = _("Article"); verbose_name_plural = _("Articles"); ordering = ['-published_at']
    def __str__(self): return self.title